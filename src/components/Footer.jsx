...
const socials = [
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/matthieu-berthier',
    icon: (
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/Matthieu56320',
    icon: (
      <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a href="#hero" className="flex items-center gap-2.5">
            ...
            <div>
              <p className="font-semibold text-white text-sm">MB Studio</p>
              <p className="text-xs" style={{ color: 'rgba(255,255,255,0.28)' }}>Développeur Freelance</p>
            </div>
          </a>
        ...
        >
          <p className="text-xs" style={{ color: 'rgba(255,255,255,0.22)' }}>
            © {year} MB Studio · Matthieu Berthier
          </p>
          <p className="text-xs" style={{ color: 'rgba(255,255,255,0.22)' }}>
            Conçu & développé en Bretagne 🌊
          </p>
        </div>
      </div>
    </footer>
